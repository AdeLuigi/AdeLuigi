...
I have projects in several languages, but JavaScript is my favorite language, you will see many projects with React, TypeScript and Node in my repositories.
 
I currently work on the CMS platform at Globo, where I develop internal and external solutions used by Globo products (globo.com, Globo Esporte, G1, Receitas, GloboPlay, etc...). These solutions impact millions of users in Brazil and around the world, with some of these apps receiving billions of requests. Due to the scale of the applications, writing clean, tested, and high-performance focused code is part of my daily routine.
